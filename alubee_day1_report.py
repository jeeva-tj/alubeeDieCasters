...
st.markdown('<div style="display:flex; align-items:center;"><img src="https://storage.cloud.google.com/alubee_bucket/biglogo.png?authuser=4" style="width:50px;height:50px;margin-right:10px;" /><h2 class="title">Alubee DIE Casters</h2>', unsafe_allow_html=True)
